...
function Tortuguita({ latamMode }) {
  ...
  const tortuguitaText = ["🇦🇷: Tortuguita.", "🇧🇷: Músculo de Primeira.", "🇪🇸: Culata.", " 🇫🇷: Nerveux de Gîte.", "🇺🇸: Leg of Beef."];
  const tortuguitaTextLatam = [
    "🇨🇱: Lagarto.",
    "🇨🇴: Lagarto de Pierna.",
    "🇪🇨: Steak al Minuto .",
    "🇲🇽: Copeta.",
  ...
  return (
    <ClickAwayListener onClickAway={handleTooltipClose}>
      <CustomTooltip
        title={<ul>{latamMode ? tortuguitaTextLatam.map((str) => <p>{str} </p>) : tortuguitaText.map((str) => <p>{str} </p>)}</ul>}
